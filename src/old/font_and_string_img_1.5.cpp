...
//ポケモン図鑑の表示するDex番号
static uint8_t dex_id = 1; //dex id 110はマタドガス
...
void getPokemonDexDetail(
    ...
    //stopByte = {0x5F};
    //バグ：110番マタドガスの図鑑情報が先頭0x5Fで出てします
    //バグ:28番サンドパンの図鑑情報が0x5Fで終わらない
    //バグ：142番プテラ　文字が抜けてる？　こだいの＊＊＊だ
    //バグ：147番ミニリュウ　文字が抜けてる？　まぼろしの＊＊＊と
    //stopByte = {0x5F};
    //「ポケモン」の文字列の置換、ニドリーノなど60バイト以上の扱いについて
    stopByte = {};
