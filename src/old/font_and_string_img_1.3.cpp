...
void displayPokemonInfo(const std::string &romPath, TFT_eSPI &tft, uint8_t dex_id,
    ...
    displaySpriteImage(compressed_sprite);
    ...
    drawBinaryString(tft, poke_information_type, 100, 134, 2, 1, romPath);
    drawBinaryString(tft, dex_detail, 100, 150, 2, 1, romPath);
